...
## Project Structure
    ...
    ├── testapiautoteammemb_76025  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_76025`
...
2. Clone this repo and `cd testapiautoteammemb_76025`
